...
app.get('/', function (req, res) {
    ...
    // 246
    const query = 'London'
    const apiKey = '9587befcd671d9b68920184868fb6b5d'

    // 👩‍🎓絶対「https」入れる
    const url = 'https://api.openweathermap.org/data/2.5/weather?q=' + query + '&appid=' + apiKey + '&units=' uni'
    ...
    https.get(url,function(response) {
        ...
        response.on('data', function(data) {
            ...
            // 解答
            res.write(`<p>The current weather of ${query} is ${desc}</p>`)
